...
int main(){
    ...
    //auto fr = rzq::search::Frontier3d();
    //fr.Update(rzq::search::Label(1, 1, rzq::basic::CostVector({ 1,2,3 }), rzq::basic::CostVector({ 1,2,3 })));

    //std::cout << fr.Check(rzq::basic::CostVector({ 1,3,2 })) << std::endl;
    //fr.Update(rzq::search::Label(1, 1, rzq::basic::CostVector({ 1,3,2 }), rzq::basic::CostVector({ 1,3,2 })));

    //std::cout << fr.Check(rzq::basic::CostVector({ 1,2,2 })) << std::endl;
    //fr.Update(rzq::search::Label(1, 1, rzq::basic::CostVector({ 1,2,2 }), rzq::basic::CostVector({ 1,2,2 })));

    //std::cout << fr.Check(rzq::basic::CostVector({ 1,3,3 })) << std::endl;
